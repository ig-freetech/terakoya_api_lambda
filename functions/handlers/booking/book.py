...
class BookingRequest:
    ...
    def __send_confirmation_email(self) -> None:
        ...
        TERAKOYA_TYPE_MAP: Dict[TERAKOYA_TYPE, str] = {
            ...
            TERAKOYA_TYPE.CHONAN: '長南校',
            TERAKOYA_TYPE.TANIGUCHI: '谷口校',
            TERAKOYA_TYPE.ASHIDA: '芦田校',
            TERAKOYA_TYPE.TADANOUMI: '忠海校',
            TERAKOYA_TYPE.TOI: '土肥校',
            TERAKOYA_TYPE.TOMARIKAWA: '泊川校',
            TERAKOYA_TYPE.SUGATA: '菅田校',
            TERAKOYA_TYPE.YAMAMORI: '山守校',
            TERAKOYA_TYPE.KATATA: '片田校',
            TERAKOYA_TYPE.NAKAMATSU: '中松校',
            TERAKOYA_TYPE.NAKATSUBARU: '中津原校',
            TERAKOYA_TYPE.NAGAWAKA: '長若校',
            TERAKOYA_TYPE.TOMARU: '外丸校',
            TERAKOYA_TYPE.KAMINOKAE: '上ノ加江校',
            TERAKOYA_TYPE.SHIMOICHI: '下市校',  
            TERAKOYA_TYPE.SYUSEI: '修正校',
            TERAKOYA_TYPE.NISYOISHI: '二升石校',
            TERAKOYA_TYPE.MANAITA: '生坂校',
            TERAKOYA_TYPE.MANZAWA: '万沢校',
            TERAKOYA_TYPE.TOKKO: '徳光校',
            TERAKOYA_TYPE.UMINOURA: '海浦校',
        }
